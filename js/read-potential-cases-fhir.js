...
(async () => {
  ...
  await fs.writeFile("coronary-revascularisation-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("coronary-revascularisation-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
